...
<main>
    ...
    <section class="section"><div class="container"><div class="card"><h2>More Jaipur-specific college research</h2><p>For another Jaipur-focused view of <?= e($program['name']) ?> options, eligibility and college profiles, explore <a href="https://collegeinjaipur.com/courses/<?= e($programKey) ?>/" target="_blank" rel="noopener">College in Jaipur's <?= e($program['name']) ?> guide</a>. Verify current programme details with each institution before applying.</p></div></div></section>
    <?php if(in_array($programKey, ['bca','mca','engineering'], true)): ?>
    <section class="section"><div class="container"><div class="card"><h2>Practical coding & IT skill resources</h2><p>Students planning software and technology careers can also compare practical training options at <a href="https://forskcodingschool.com/" target="_blank" rel="noopener">Forsk Coding School</a> and <a href="https://jaipurengineers.com/" target="_blank" rel="noopener">Jaipur Engineers</a>. These are separate training resources, so confirm current syllabus, fees and batch details directly with each provider.</p></div></div></section>
    <?php endif; ?>
